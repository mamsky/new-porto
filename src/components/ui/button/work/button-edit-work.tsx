...
const ButtonEditWork = ({ workData }: { workData: WorkTypeData }) => {
  ...
  return (
    <AlertDialog>
      ...
      <AlertDialogContent className="max-h-screen overflow-y-auto md:min-w-2xl">
        <AlertDialogHeader>
        ...
        <div className="flex gap-4 overflow-auto">
          {dataTechnology.map((data, i) => (
            <div
              key={i}
              className="bg-white/30 rounded-xl flex items-center w-full gap-4 p-2  md:py-2 md:px-4 text-sm"
            >
